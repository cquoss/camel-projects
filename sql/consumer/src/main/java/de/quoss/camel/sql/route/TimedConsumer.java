...
public class TimedConsumer extends EndpointRouteBuilder {
    
    static final String ROUTE_ID = "timed-consumer";
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(TimedConsumer.class);

    @Override
    public void configure() {
                
        from(timer(ROUTE_ID).period(30000L))
                .routeId(ROUTE_ID)
